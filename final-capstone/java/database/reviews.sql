...
INSERT INTO reviews (beer_id, reviewer_id, review_text, star_rating) values (5, 5, "Great new IPA, I enjoyed the taste, body and appearance. Tends to be a little dry, very similar to Fiddlehead. I've always enjoyed Sierra Nevada Pale Ale, and Hazy Little Thing is a nice complement.", 4.6);
INSERT INTO reviews (beer_id, reviewer_id, review_text, star_rating) values (5, 5, "This is just unwavering and completely solid, I'm not mind blown but perfectly content with the decision, this is my first beer from SN actually so now im looking more forward to the classic pale ale and the other products.", 4);
...
INSERT INTO reviews (beer_id, reviewer_id, review_text, star_rating) values (6, 1, "Had this in a hotel lobby. Then had several. Best hoppy pils attempt that I've had. most are decent injections of bitterness during which your left brain thinks you're having a miller lite. This brew has nothin to hide.", 4.6);
...
INSERT INTO reviews (beer_id, reviewer_id, review_text, star_rating) values (7, 2, "Handsome amber brew with plenty of foam in the Dupont chalice. This is not as intensely bitter as typical craft IPAs. But it's also quite flavorful without being a fruit bomb. Aroma of lime peel and a Salty dog.", 3.73);
...
INSERT INTO reviews (beer_id, reviewer_id, review_text, star_rating) values (8, 2, "Stone brewing does a lot of IPA's so it is surprising to find another IPA in their line up. Not really. I find myself gravitating towards the scorpion bowl IPA yet this one is another good IPA from folks who know how to make an IPA.", 3.9);
